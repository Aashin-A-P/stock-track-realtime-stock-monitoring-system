...
router.post('/register', verifyToken, validateData(createUserSchema), logger, registerUser);
router.put('/:userId', verifyToken, validateData(updateUserSchema), logger, updateUser);
